namespace Score247.IntegrationTests
{
    ...
    {
        [Get("/Match/AutoCreateMatch?createDate={createDate}")]
        Task<AutoGeneratedMatch> AutoGenerateMatch(DateTimeOffset createDate);

        [Get("/Match/AutoCreateEvent?matchId={matchId}&eventName={eventName}&time={time}")]
        Task<dynamic> AutoGenerateEvent(string matchId, string eventName, DateTimeOffset time);
    }
