...
BEGIN
    ...
    WHILE i < e DO
       INSERT INTO `News`
		(`Title`, `SportId`, `Language`, `Content`, `ImageName`, `ImageSource`, `Link`, `Author`, `PublishedDate`, `CreatedTime`, `Provider`)
		VALUES
			(
            ...
            JSON_UNQUOTE(JSON_EXTRACT(news, CONCAT('$[', i, '].ImageName'))),
